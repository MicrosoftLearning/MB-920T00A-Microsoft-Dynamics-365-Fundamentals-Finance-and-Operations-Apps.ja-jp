...
1. **[価格]** の **[購入価格]** ボックスに、「**30.00**」と入力します。
...
1. 製品が最終決定されていることを確認するために、[アクション] ペインで **[製品]** を選択し、**[メンテナンス]** で **[有効]** を選択します。
...
1. [リリースされた製品の詳細] ページで、製品番号 **"GTL201"** を検索します。

1. **[GTL201]** の左にある **[行の選択または選択解除]** チェックボックスをオンにします。

1. [アクション] ペインで **[販売]** を選択し、**[売買契約]** で **[売買契約の作成]** を選択します。
...
1. [売買契約] ページの [仕訳] 行の **[項目関係]** 列で、このメニューを選択したら、**[GTL201]** を選択します。

1. このパラメータは作成した製品の品目番号です。

1. **[倉庫]** 列で、メニューを選択したら、**[150]** を選択します。

1. 列を表示させるために右へスクロールする必要がある場合があります。

1. このボックスの **[通貨の金額]** 列に、「**100.00**」と入力します。

1. [詳細] セクションの **[開始日]** ボックスに今年度の期首日を入力します。

1. [アクション] ペインで、**[検証]**  >  **[すべての行を検証]** の順に選択します。

1. **[価格/割引仕訳の転記]** ペインで、**[OK]** を選択します。
...
1. [リリースされた製品の詳細] ページの [アクション] ペインの **[販売]**  >  **[売買契約]** で、**[売買契約を表示]** を選択します。

1. 売買契約が転記されるはずです。 行を再確認して価格情報を再確認してください。

1. このページを閉じて、ホーム ページに戻ります。
...
1. [アクション] ペインで **[新しい製造オーダー]** を選択します。

1. **[製造オーダーの作成]** ペインの **[ID]** の下にある **[品目番号]** ボックスに、「**D0004**」と入力し、特定された品目を選択します。

1. **[製造]** の **[出荷]** ボックスで、今日の日付から 1 か月後の日付を選択します。
...
1. **[在庫仕訳帳の作成]** ペインの **[カウントの基準]** で、**[倉庫]** のトグルを **[はい]** に選択します。

1. **[OK]** を選択します。

1. [在庫棚卸仕訳帳] ページの **[仕訳見出しの詳細]** クイックタブのツールバーで、**[仕分け] 行** から **[+ 新規]** を選択します。

1. **品目番号** 列で、メニューを選択し、**GTL201** を選択します。

1. **[倉庫]** 列で、メニューを選択したら、**[150]** を選択します。

1. **[カウント]** ボックスに、「**100.00**」と入力します。
...
1. **[分析コードの表示]** ペインの **[保管分析コード]** で、**[サイト]** と **[倉庫]** のチェックボックスをオンにしたら、**[OK]** を選択します。

1. **[フィルター]** ペインで **[適用]** を選択します。

1. **[GTL201]** の手持ちの在庫の場所を見つけて確認します。
...
1. ナビゲーション ウィンドウで、**[モジュール]**  >  **[調達]**  >  **[発注書]**  >  **[すべての発注書]** の順に選択します。
...
1. **[全般]** セクションの **[保管分析コード]** で、**[サイト]** メニューを選択し、**[ホーム スピーカー 1 台を製造]** を選択します。

1. **[日付]** で、今日から 1 週間後となる **[納入日]** を選択します。

1. **[管理]** を選択します。

1. **[発注者]** メニューを選択したら、**[Lars Giusti]** を選択して、発注者を特定します。

1. **[発注書作成]** ペインで **[OK]** を選択します。

1. ツールバーで **[発注書明細行]** を選択します。

1. **[表示]** で **[分析コード]** を選択します。

1. **[製品分析コード]** の **[分析コードの表示]** ペインで、**[色]** チェック ボックスをオンにします。

1. **[OK]** を選択します。

1. **[品目番号]** 列からメニューを選択し、**[T0005]** を選択します。

1. **[バリアント番号]** 列で、メニューを選択し、いずれかの色を選択します。

1. **[数量]** ボックスに、「**15**」と入力します。

1. ページの下部にある **[発注書明細行]** で、**[明細行の詳細]** を選択します。

1. このタブはすでに展開されていることもあります。

1. **[出荷]** タブの **[出荷日]** ボックスで、現在割り当てられている日付を使用するか、将来の日付を入力します。  
...
1. [すべての発注書] ページで **フィルター** 機能を使用して、新しい発注書を検索します。
